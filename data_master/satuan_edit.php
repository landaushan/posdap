...
opendb();
	...
	//cari data barang
	$qri = "SELECT * FROM ma_satuan_barang WHERE kd_satuan='$kode'";
	$hsl = querydb($qri);
	$rek = arraydb($hsl);
	$dtaNama = $rek['nm_satuan'];
...
?>
			...
			<div class="panel panel-primary alert alert-dissmisable alert-warning" id="">
			<div class="panel-heading"><span class="glyphicon glyphicon-refresh"></span>&nbsp;&nbsp;UBAH DATA SATUAN BARANG
				...
				<div class="panel-body">
					<form class="form-horizontal" action="" method="post" name="formSatuan" id="formSatuan" target="" enctype="multipart/form-data" >
						...
						<div class="col-sm-2 col-sm-offset-3"><input type="submit" name="btnSatuanSimpan" value=" Simpan " class="btn btn-primary btn-sm" id="btnSatuanSimpan" data-id="2"/> </div>
					</form>
				</div><!-- /panel body -->	
			</div><!-- /panel -->
