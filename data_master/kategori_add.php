...
$kode =buatKode("ma_kategori_barang","K");


 ?>   
   
		<div class="panel panel-primary alert alert-dissmisalbe alert-info" id="">
			<div class="panel-heading"><span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;TAMBAH DATA KATEGORI BARANG
			...
			<div class="panel-body">
				<form class="form-horizontal" action="" method="post" name="formKategori" id="formKategori" target="" enctype="multipart/form-data" >
					...
					<div class="col-sm-2 col-sm-offset-3"><input type="submit" name="btnKategoriSimpan" id="btnKategoriSimpan" value=" Simpan " class="btn btn-primary btn-sm" data-id="1" /> </div>
				</form>
			</div><!-- /panel body -->	
		</div><!-- /panel -->
