...
//Menentukan batas, cek halaman dan posisi data
		...
		$qry2 ="SELECT * FROM ma_satuan_barang";
		$hsl2 = querydb($qry2);
		...
		//$file="page.php?open=data_master/satuan_data.php";
		$file="page.php?open=satuan_data";
?>
        ...
        <div class="span12">
          <div class="widget">
            <div class="widget-header"> <i class="icon-copy"></i>
              ...
              <button class="btn btn-info btn-sm" id="btnSatuanTambah">Tambah Data</button>
            </div>
            <!-- /widget-header -->
              ...
              <div class="shortcuts"> 
				...
				<p></p>
					...
					<table class="table table-striped table-bordered table-condensed table-hover">
						...
						<?php
							$c=1;
							$qri = "SELECT a.* FROM ma_satuan_barang a LIMIT $posisi, $batas";
							$hsl = querydb($qri);
							while($rek = arraydb($hsl)){
							 ...
							 echo "<td align='center'>".$rek['kd_satuan']."</td>";
							 echo "<td align='left'>".$rek['nm_satuan']."</td>";
							 echo "<td align='center'>".$stat."</td>";
							 echo "<td align='center'><button class=\"btn btn-warning btn-xs btnSatuanUbah\" data-val=\"$rek[kd_satuan]\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"Edit Data\"><span class=\"shortcut-icon icon-pencil\"></span></button></td>";
							 echo "<td align='center'><button class=\"btn btn-danger btn-xs btnSatuanHapus\" data-val=\"$rek[kd_satuan]\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"Hapus Data\"><span class=\"shortcut-icon icon-remove\"></span></button></td>";
							 echo "<tr>";
								$c++;
							}
						?>
